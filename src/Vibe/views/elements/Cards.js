                ...
                <Col md={4}>
                    <Card>
                        ...
                        <CardBody>
                            ...
                            elit. Morbi id neque quam. Aliquam-a-0 m-b-smitudin
                            egestas dui nec, fermentum diam. Vivamus vel
                            tincidunt libero, vitae elementu
                        </CardBody>
                    </Card>
                    <Card>
                        <CardImg src={laptopImage} top width="100%"
                                 alt="laptop"/>
                        <CardBody>
