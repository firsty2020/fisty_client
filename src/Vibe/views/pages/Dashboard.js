                    ...
                    <Col md={6}>
                        <div className="home-hero" style={heroStyles}>
                            ...
                            <p className="text-muted">
                                Discover this UI dashboard framework that will
                                help speed up
                        ...
                        <Card>
                            <CardBody className="display-flex">
                                ...
                                <div className="m-l">
                                    ...
                                    <p className="text-muted">
                                        Built to quickly get your MVPs off the
                                        ground.
                                    </p>
                                </div>
                            </CardBody>
                        ...
                        <Card>
                            <CardBody className="display-flex">
                                ...
                                <div className="m-l">
                                    ...
                                    <p className="text-muted">
                                        The most popular framework to get your
                                        layouts built.
                                    </p>
                                </div>
                            </CardBody>
                        ...
                        <Card>
                            <CardBody className="display-flex">
                                ...
                                <div className="m-l">
                                    ...
                                    <p className="text-muted">
                                        Easily change the design system styles
                                        to fit your needs.
                                    </p>
                                </div>
                            </CardBody>
