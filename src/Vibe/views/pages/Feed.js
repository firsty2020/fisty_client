                ...
                <Col md={{size: 8, offset: 2}}>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <h5 className="inline m-b-none m-t-none">George
                                Costanza</h5>
                        </CardHeader>
                        <CardBody>
                            <div>
                            ...
                            <div>
                                <Avatar initials="DP" color="success"
                                        size="small"/>
                                <Avatar initials="NM" color="gold" size="small"
                                        className="m-l-n-sm"/>
                                <small className="m-l-sm text-muted">David
                                    Putty, Newman and 12 others.</small>
                            </div>
                            <PostActions/>
                        </CardBody>
                        <CardFooter>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <h5 className="inline m-b-none m-t-none">Elaine
                                Benis</h5>
                        </CardHeader>
                        <CardBody>
                            <div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <h5 className="inline m-b-none m-t-none">Cosmo
                                Kramer</h5>
                        </CardHeader>
                        <CardBody>
                            <div>
                                <h3>Lookin' forward to Little Jerry's fight
                                    tonight. Who's coming?</h3>
                            </div>
                            <PostActions/>
                        </CardBody>
                        <CardFooter>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <h5 className="inline m-b-none m-t-none">Jerry
                                Seinfeld</h5>
                        </CardHeader>
                        <CardBody>
                            <div>
                                <p>
                                    Whats the deal with dashboard designs? Is
