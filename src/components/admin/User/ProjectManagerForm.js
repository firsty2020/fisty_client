...
const ProjectManagerForm = ({ pending, projectManager, onSubmit }) => {

    if (projectManager) {
        formValues = fillForm(initialValues, projectManager);
    } else {
...
export default connect(mapStateToProps, null)(ProjectManagerForm);
